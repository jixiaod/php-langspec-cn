...
Facebook 已经把所有该规范的版权贡献给献给CC0公共域协议，在这里查看该协议内容
<http://creativecommons.org/publicdomain/zero/1.0/>。本规范的发布不提供任何保证。

(Facebook 公司在2014年发起该项目，2014.07)
...
- [基本概念](04-basic-concepts.md#基本概念)
  ...
  - [ 中断编译器执行](04-basic-concepts.md#__halt_compiler)
  - [内存模型](04-basic-concepts.md#the-memory-model)
